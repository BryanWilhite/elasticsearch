...
namespace ElasticSearch.Tests
{
    public partial class ElasticSearchTests
    {
        ...
        /// <param name="ioFile">the <cref="FileSystemInfo" /></param>
        /// <remarks>
        /// This operation uses <c>refresh=wait_for</c> to ensure that the caller waits
        ...
        /// <summary>
        /// POSTs an update to the specified customer property added
        ...
        /// <param name="ioFile">the <cref="FileSystemInfo" /></param>
        /// <remarks>
        /// This operation uses <c>refresh=true</c> to ensure that the caller waits
        /// for the index to refresh after the update.
        /// </remarks>
        [Theory]
